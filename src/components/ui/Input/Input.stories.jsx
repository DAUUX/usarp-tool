...
Password.parameters = {
  docs: {
    description: {
      story: "Campo de senha com botão para mostrar/ocultar a senha.",
    },
  },
};
...
Textarea.parameters = {
  docs: {
    description: {
      story: "Input transformado em área de texto de múltiplas linhas.",
    },
  },
};
...
WithError.parameters = {
  docs: {
    description: {
      story: "Campo em estado de erro com mensagem de ajuda.",
    },
  },
};
...
Disabled.parameters = {
  docs: {
    description: {
      story: "Campo desabilitado - usuário não pode interagir.",
    },
  },
};

export const WithLengthLimits = Template.bind({});
WithLengthLimits.args = {
  label: "Username",
...
WithLengthLimits.parameters = {
  docs: {
    description: {
      story: "Campo com validação de comprimento mínimo e máximo.",
    },
  },
};
